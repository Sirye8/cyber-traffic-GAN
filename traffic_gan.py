...
# Google Colab Paths
#output_path = '/content/drive/MyDrive/generated_traffic_samples.csv'
#file_path = '/content/drive/MyDrive/CTU-IoT-Malware-Capture-1-1conn.log.labeled.csv'
...
# === Load dataset ===
output_path = "generated_samples/generated_traffic_samples.csv"
...
for epoch in range(epochs):
    for real_data, _ in dataloader:
        ...
        # Add mild noise - make sure noise is on same device
        ...
        noise = torch.randn(batch_size, latent_dim, device=device)  # noise on device
